...
echo $i "  Tools    : Evil Installer v2"
echo $bi "(-------------------------------------------)"
echo
sleep 1
echo
...
sleep 4
echo $me "---------------------------------------------"
echo $cy "Dasar Jones Tingkat Dewa Wkwkwk"
echo $me "---------------------------------------------"
sleep 4
echo $me "---------------------------------------------"
echo $cy "Sorry Gw Bercanda"
echo $me "---------------------------------------------"
sleep 5
clear
echo $me "---------------------------------------------"
...
sleep 4
echo $me "---------------------------------------------"
echo $cy "Bisa Hubungi Langsung Pembuat Script/Admin"
echo $me "---------------------------------------------"
sleep 4
echo $me "---------------------------------------------"
echo $cy "Grup [ Evil Hacker Team ]"
echo $me "---------------------------------------------"
sleep 4
echo $me "---------------------------------------------"
echo $cy "Ray Gans ( M1234H_404 )"
echo $me "---------------------------------------------"
sleep 4
echo $me "---------------------------------------------"
...
sleep 1
clear
echo $cy"Terima Kasih Sudah Menggunakan Tools Evil Installer v2"
sleep 0.5
